...
public class DomesticSreemangal extends JFrame {
 ...
 JPanel backgroundPanel = new JPanel() {
...

    {
        ...
        bg_image = new ImageIcon(getClass().getResource("/images/sreemangal.jpeg"));
    ...
    protected void paintComponent(Graphics g) {
        ...
        float opacity = 0.3f; // Adjust as needed
...
setContentPane(backgroundPanel); // Set custom panel as content pane
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Sreemangal Tour!");
        ...
        // label2.setBounds(190, 70, 500, 50);
        // label2.setFont(f1);
        // c.add(label2);
